    ...
    return (
        <main>
            ...
            <section className='p-4 bg-[#005e74] text-white'>
                <h1 className='title sm:text-[2.5rem] '><i className='bx bxs-book-open'></i> Comprensión lectora</h1>
