...
const TabsRead = () => {
    ...
    return (
        <main>            
            <section className='bg-[#916400] text-white  pb-5 '>
                <section className=' w-[100%] h-auto flex justify-center m-auto '>
                    <article className='p-4 '>        
                    <p className=' text-center '><i className='bx bxs-hand-down py-6 font-bold'> Haz clic en el título para desplegar la información correspondiente.</i></p>                
                        <div className='flex justify-center mb-4 py-3 w-[95%] h-[100px] ' >
                            <button onClick={() => handleView(1)} className='hover:bg-[#005e74] px-1 font-bold transition-colors duration-500 border flex flex-col justify-center items-center' ><i className='bx bx-book-reader'></i>Lectura universitaria</button>
                            <button onClick={() => handleView(2)} className='hover:bg-[#005e74] px-1 font-bold transition-colors duration-500 border flex flex-col justify-center items-center' > <i className='bx bx-text'></i> Textos académicos</button>
                            <button onClick={() => handleView(3)} className='hover:bg-[#005e74] px-1 font-bold transition-colors duration-500 border flex flex-col justify-center items-center' > <i className=' bx bxs-component'></i> Lectura y tecnología</button>
                        </div>
                        {IsVisible === 1 && <section className='transition-all duration-700 animate-fade-up
                        ...
                        {IsVisible === 2 && <section className='transition-all duration-700 animate-fade-down
                        bg-white/70 text-black p-2 rounded-xl' >
                        ...
                        {IsVisible === 3 && <section className='transition-all duration-700 animate-fade-right '  >
