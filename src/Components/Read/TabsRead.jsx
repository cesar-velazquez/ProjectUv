        ...
        <main>            
            <section className='bg-[#916400] text-white  pb-5 '>
                <section className=' w-[100%] h-auto flex justify-center m-auto '>
                    ...
                    <p className=' text-center sm:text-2xl '><i className='bx bxs-hand-down py-6 font-bold'> Haz clic en el título para desplegar la información correspondiente.</i></p>                
                        <div className='flex justify-center mb-4 py-3 w-[95%] h-[100px]
                        sm:w-[900px] sm:m-auto sm:my-2  ' >
                            ...
                            sm:w-[300px] sm:text-2xl ' ><i className='bx bx-book-reader'></i>Lectura universitaria</button>
                            ...
                            sm:w-[300px] sm:text-2xl ' > <i className='bx bx-text'></i> Textos académicos</button>
                            ...
                            sm:w-[300px] sm:text-2xl ' > <i className=' bx bxs-component'></i> Lectura y tecnología</button>
                        </div>
                        {IsVisible === 1 && 
                        <section className='transition-all duration-700 animate-fade-up
                        bg-white/70 text-black p-2 rounded-xl sm:w-[900px] sm:p-4 sm:grid sm:gap-4 sm:text-xl ' >
                        ...
                        sm:w-[900px] sm:p-4 sm:grid sm:gap-4 sm:text-xl ' >
                        ...
                        sm:w-[940px] sm:p-4 sm:grid sm:gap-4 sm:text-xl '  >
