    ...
    return (
        ...
        sm:w-[300px] lg:w-[450px] sm:bg-[#000000] my-2 p-4 h-auto ">
            ...
            <Slider {...settings}>
                ...
                <div className="slide-item">
                    <img className="m-auto w-[100%] h-[250px]" src="/imgs/write4.jpg" alt="Prueba" />
                ...
                <div className="slide-item">
                    <img className="m-auto h-[250px] w-[100%]" src="/imgs/leer6.jpg" alt="Prueba" />
